...
// Extend the TCPDF class to create custom Header and Footer
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            ...
            $html = '<table cellspacing="0" cellpadding="6">
                ...
                <tr>
                <td colspan="6" align="center"><b>Sick Leave Report of ' . $empid . ' in ' . $year . '</b></td>
                </tr>
                </table>';
    ...
    $html .='<tr>
        ...
        <tr>
        <td colspan="9">Total Days :' . $count . '</td>
            </tr>
        ';
    $sa=0;
    $dy=0;
    if($count>14){
        ...
        $html .='
            <tr>
        <td colspan="9">Sick allowance :<b>' . $sa . '</b>Rs only</td>
        </tr>
        <tr>
        <td colspan="9">Extra Days :<b>' . $dy . '</b></td>
        </tr>
        ';
    }else{
        $sa=$rate * $count;
    ...
    $html .='<tr>
        <td colspan="9"><i style="font-size:10px;">Sick allowance is valid upto 14 days leave @ ' . $rate . 'Rs only</i></td>
        </tr>';
    $html .= '</table>
                 </body>
                 </html>';
